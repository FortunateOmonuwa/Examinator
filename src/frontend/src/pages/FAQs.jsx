...
const FAQs = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "In the current version, there is no limit to the number of exams you can create as an examiner.",
    },
    {
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                <div className={`faq-answer px-6 pb-6 ${openFaq === index ? "block" : "hidden"}`}>
