      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Our team of educators and developers recognized the challenges
              faced by both examiners and students in traditional examination
              systems. We set out to build a platform that addresses these pain
              points while providing a seamless experience.
            </p>
            {/* <p className="text-gray-600">
              Today, Examinator is used by educational institutions, training centers, and corporate organizations
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            To empower educators and learners with innovative examination tools
            that promote fairness, accessibility, and meaningful assessment.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div className="value-card bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600">
              We believe in the power of working together to create better
              solutions.
            </p>
          </div>
          <div className="value-card bg-white p-6 rounded-lg shadow-md text-center">
          ...
          <div className="value-card bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600">
              We uphold the highest standards of integrity and ethics in our
              operations.
            </p>
          </div>
          <div className="value-card bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600">
              We continuously innovate to improve the examination experience.
            </p>
          </div>
        </div>
